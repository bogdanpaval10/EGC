...
void Lab2::Init()
{
    ...
    // by definition!
    {
        vector<VertexFormat> vertices
        {
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0, 1, 1), glm::vec3(.5f, .5f, 1.f)),
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0, 1, 1), glm::vec3(1.f, .5f, 1.f)),
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(0, 1, 1), glm::vec3(.75f, .25f, .25f)),
            VertexFormat(glm::vec3(0, 0, 1), glm::vec3(0, 1, 1), glm::vec3(1.f, .5f, .5f))
        };
...

    {
        vector<VertexFormat> vertices
        {
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(1, 0, 0), glm::vec3(.5f, .5f, 1.f)),
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(1, 0, 0), glm::vec3(1.f, .5f, 1.f)),
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(1, 0, 0), glm::vec3(.75f, .25f, .25f)),
            VertexFormat(glm::vec3(0, 0, 1), glm::vec3(1, 0, 0), glm::vec3(1.f, .5f, .5f))
        };
        ...
        CreateMesh("tetra1", vertices, indices);
    }
    {
        vector<VertexFormat> vertices
        {
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(1, 1, 0), glm::vec3(.5f, .5f, 1.f)),
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(1, 1, 0), glm::vec3(1.f, .5f, 1.f)),
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(1, 1, 0), glm::vec3(.75f, .25f, .25f)),
            VertexFormat(glm::vec3(0, 0, 1), glm::vec3(1, 1, 0), glm::vec3(1.f, .5f, .5f))
        };
        ...
        CreateMesh("tetra2", vertices, indices);
    }
    {
        vector<VertexFormat> vertices
        {
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(1, 0, 1), glm::vec3(.5f, .5f, 1.f)),
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(1, 0, 1), glm::vec3(1.f, .5f, 1.f)),
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(1, 0, 1), glm::vec3(.75f, .25f, .25f)),
            VertexFormat(glm::vec3(0, 0, 1), glm::vec3(1, 0, 1), glm::vec3(1.f, .5f, .5f))
        };
        ...
        CreateMesh("tetra3", vertices, indices);
    }
    {
        vector<VertexFormat> vertices
        {
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0, 1, 0), glm::vec3(.5f, .5f, 1.f)),
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0, 1, 0), glm::vec3(1.f, .5f, 1.f)),
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(0, 1, 0), glm::vec3(.75f, .25f, .25f)),
            VertexFormat(glm::vec3(0, 0, 1), glm::vec3(0, 1, 0), glm::vec3(1.f, .5f, .5f))
        };
        ...
        CreateMesh("tetra4", vertices, indices);
    }
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["tetra"], shaders["VertexColor"], glm::vec3(0, -0.5f, -1.5f), glm::vec3(0.50f));

    // TODO(student): Draw the square
    RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(3.0f, -1.5f, 3.0f), glm::vec3(0.50f));

    RenderMesh(meshes["tetra1"], shaders["VertexColor"], glm::vec3(1, 1, -1), glm::vec3(0.75f));
    RenderMesh(meshes["tetra2"], shaders["VertexColor"], glm::vec3(1, 1, -1), glm::vec3(0.75f));
    RenderMesh(meshes["tetra3"], shaders["VertexColor"], glm::vec3(1, 1, -1), glm::vec3(0.75f));
    RenderMesh(meshes["tetra4"], shaders["VertexColor"], glm::vec3(1, 1, -1), glm::vec3(0.75f));
