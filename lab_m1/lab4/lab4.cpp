...
void Lab4::Update(float deltaTimeSeconds)
{
    ...
    modelMatrix = glm::mat4(1);
    val_x += deltaTimeSeconds;
    modelMatrix *= transform3D::Translate(val_x, 2.5, 0);
    RenderMesh(meshes["box"], shaders["VertexNormal"], modelMatrix);

    unghi += deltaTimeSeconds;
    modelMatrix *= transform3D::Scale(1.f, 1.f, 1.f);
    modelMatrix *= transform3D::RotateOY(unghi * 0.6f);
    modelMatrix *= transform3D::Translate(2.6f, 0, 2.6f);
    RenderMesh(meshes["box"], shaders["VertexNormal"], modelMatrix);

    modelMatrix *= transform3D::Scale(0.3f, 0.3f, 0.3f);
    modelMatrix *= transform3D::RotateOY(unghi * 7.6f);
    modelMatrix *= transform3D::Translate(2.6f, 0, 2.6f);
    RenderMesh(meshes["box"], shaders["VertexNormal"], modelMatrix);
