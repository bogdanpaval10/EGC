...
void Lab8::Init()
{
    ...
    // Light & material properties
    {
        ...
        lightPosition2 = glm::vec3(1, 0.5, 1);
...
void Lab8::RenderSimpleMesh(Mesh* mesh, Shader* shader, const glm::mat4& modelMatrix, const glm::vec3& color)
{
    ...
    GLint type = glGetUniformLocation(shader->program, "type_light");
    glUniform1i(type, typeLight);


    GLint cuttOffAngle = glGetUniformLocation(shader->program, "cutt_angle");
    glUniform1f(cuttOffAngle, cuttAngle);
...
void Lab8::OnInputUpdate(float deltaTime, int mods)
{
    ...
    if (!window->MouseHold(GLFW_MOUSE_BUTTON_RIGHT))
    {
        ...
        turn = glm::rotate(turn, angleY, glm::vec3(0, 1, 0));
        turn = glm::rotate(turn, angleX, glm::vec3(1, 0, 0));

        lightDirection = glm::vec3(turn * glm::vec4(0, -1, 0, 0));
